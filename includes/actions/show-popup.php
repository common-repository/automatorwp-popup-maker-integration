...
class AutomatorWP_Popup_Maker_Show_Popup extends AutomatorWP_Integration_Action {
    ...
    public function register() {
        ...
        automatorwp_register_action( $this->action, array(
            ...
            'label'             => __( 'Show a popup', 'automatorwp-popup-maker-integration' ),
            'select_option'     => __( 'Show a <strong>popup</strong>', 'automatorwp-popup-maker-integration' ),
            /* translators: %1$s: Post title. */
            'edit_label'        => sprintf( __( 'Show %1$s', 'automatorwp-popup-maker-integration' ), '{post}' ),
            /* translators: %1$s: Post title. */
            'log_label'         => sprintf( __( 'Show %1$s', 'automatorwp-popup-maker-integration' ), '{post}' ),
            'options'           => array(
                'post' => automatorwp_utilities_post_option( array(
                    'name' => __( 'Popup:', 'automatorwp-popup-maker-integration' ),
                    'option_default' => __( 'a popup', 'automatorwp-popup-maker-integration' ),
                    'option_none' => false,
                    'option_custom'         => true,
                    'option_custom_desc'    => __( 'Popup ID', 'automatorwp-popup-maker-integration' ),
                    'post_type' => 'popup'
                ) ),
            ),
        ) );
